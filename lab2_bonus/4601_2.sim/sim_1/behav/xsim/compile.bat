...
REM
REM Generated by Vivado on Thu Feb 26 19:12:03 +1100 2026
...
echo "xvlog --incr --relax -prj bonus_tb_vlog.prj"
call xvlog  --incr --relax -prj bonus_tb_vlog.prj -log xvlog.log

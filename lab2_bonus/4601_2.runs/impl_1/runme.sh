...
HD_PWD='C:/Users/ibrah/4601_2/4601_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bonus_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bonus_wrapper.tcl -notrace

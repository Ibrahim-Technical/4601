...
HD_PWD='C:/Users/ibrah/4601_2/4601_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bonus_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bonus_wrapper.tcl
